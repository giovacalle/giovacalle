...
`Bun` · `TypeScript` · `React (Next.js, React Router, TanStack Router)` · `Svelte (SvelteKit)` · `Databases (Postgres, SQLite)`

Lately into edge runtimes — especially around Cloudflare (`Workers`, `D1`, `Durable Objects`, `KV`, `R2`) — structured AI workflows with Claude Code and Codex, and self-hosting on [Coolify](https://coolify.io) because I like knowing exactly what my infra costs.
